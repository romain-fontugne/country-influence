...
def run(cc_isps, year, month):
    START_DATE = '2022-05-01T00:00'
    END_DATE = '2022-05-07T00:00'
    CC_ISPS = 'ES'
...
if __name__ == '__main__':
    ...
    parser.add_argument("country_code", 
                help="Country code whose influence is to be measured."
                    " Can contain several country codes separatated by commas (e.g. CN,HK)",
                        )
